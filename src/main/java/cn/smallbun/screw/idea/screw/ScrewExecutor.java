package cn.smallbun.screw.idea.screw;
...
public class ScrewExecutor {
    ...
    public static void main(String[] args) {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://10.6.70.114:3306/beta");
        hikariConfig.setUsername("root");
        hikariConfig.setPassword("tansun@xyk123");
        //设置可以获取tables remarks信息
        hikariConfig.addDataSourceProperty("useInformationSchema", "true");
        hikariConfig.setMinimumIdle(2);
        hikariConfig.setMaximumPoolSize(5);
        ...
        EngineConfig engineConfig = EngineConfig.builder()
                //生成文件路径
                .fileOutputDir("/Users/yuanwenjian/github/idea-plugin")
                //打开目录
                .openOutputDir(true)
                //文件类型
